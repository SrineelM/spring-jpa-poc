...
@EnableJpaAuditing // Enables JPA auditing to automatically populate @CreatedDate, @LastModifiedDate, etc.
@EnableCaching // Enables Spring's caching abstraction, allowing methods to be cached using annotations like @Cacheable
...
public class DemoApplication {
    ...
    public static void main(String[] args) {
        ...
        // This initializes the application context, loads configurations, and performs classpath scanning
        app.run(args);

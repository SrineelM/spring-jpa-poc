...
public class AsyncConfig {
    ...
    public Executor taskExecutor(MeterRegistry meterRegistry) {
        ...
        Gauge.builder("async.executor.pool.size", () -> executor.getThreadPoolExecutor()
                        .getPoolSize())
        ...
        Gauge.builder("async.executor.active", () -> executor.getThreadPoolExecutor()
                        .getActiveCount())
        ...
        Gauge.builder("async.executor.completed", () -> executor.getThreadPoolExecutor()

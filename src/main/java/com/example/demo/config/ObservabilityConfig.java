...
/**
 * Configuration for comprehensive observability and metrics using Micrometer. This class enables
 * and configures aspects for monitoring the application's performance.
 */
@Configuration
...
public class ObservabilityConfig {
  ...
  /**
   * Customizes the MeterRegistry to add common tags to all metrics. Common tags are useful for
   * filtering and aggregating metrics in a monitoring system.
   *
  ...
  /**
   * Creates a TimedAspect bean to enable the @Timed annotation. This aspect automatically records
   * timing metrics for methods annotated with @Timed.
   *
  ...
  /**
   * Creates a CountedAspect bean to enable the @Counted annotation. This aspect automatically
   * records count metrics for methods annotated with @Counted.
   *
   * @param registry The MeterRegistry to which the metrics are reported.
  ...
  /**
   * Creates a Timer.Sample bean for programmatic timing. This allows for more fine-grained control
   * over timing measurements within the code.
   *

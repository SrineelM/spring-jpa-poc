 ...
 * It inherits auditing fields from BaseEntity.
 */
@Entity
@Table(name = "comments")
public class Comment extends BaseEntity {
     ...
     * The @Lob annotation specifies that this should be stored as a Large Object in the database,
     ...
     * FetchType.LAZY is used for performance, so the Post is not loaded until it's explicitly accessed.
     */
     ...
     * This is another many-to-one relationship, linking the comment to its author.
     * FetchType.LAZY is also used here for performance.
     */
    @ManyToOne(fetch = FetchType.LAZY)
     ...
     * This is a common practice for JPA entities to ensure they are compared by identity.
     */
    @Override
     ...
     * Uses the entity's ID for the hash code.
     */
    @Override
    public int hashCode() {

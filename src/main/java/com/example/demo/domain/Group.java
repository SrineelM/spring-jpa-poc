 ...
 * This entity has a many-to-many relationship with the User entity.
 */
@Entity
...
public class Group extends BaseEntity {
     ...
     * indicated by the `mappedBy = "groups"` attribute. The `groups` field
     * is defined in the User entity, which is the owning side.
     */

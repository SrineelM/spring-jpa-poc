...
/**
 * A JPA AttributeConverter to store a List of Strings as a single comma-separated String in the database.
 * This is useful for simple collections of strings where a separate table would be overkill.
 * The {@link Converter} annotation with `autoApply = true` would automatically apply this converter
 * to all attributes of type `List<String>`, but it's often better to apply it explicitly

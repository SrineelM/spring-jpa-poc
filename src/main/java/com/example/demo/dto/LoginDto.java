...
/**
 * Login request payload. Sent by the client when attempting to authenticate. Only contains
 * credentials – no domain logic here; validation (e.g. @NotBlank) can be added later if Bean

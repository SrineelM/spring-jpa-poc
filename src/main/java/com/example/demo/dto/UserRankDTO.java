...
/**
 * Projection DTO representing a user's relative ordering inside a particular role. Useful for
 * leaderboard / ranking style API responses.
 */
public class UserRankDTO {
  ...
  private String
      createdAt; // Formatted creation timestamp for display (string to avoid tz issues in clients)
  ...
  public UserRankDTO(
      Long id, String name, String role, String createdAt, Integer roleRank, Long totalInRole) {
    this.id = id;
    this.name = name;
    this.role = role;

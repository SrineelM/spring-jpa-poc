...
/**
 * Synchronous simple variant of a user lifecycle event. Published right after a User entity is
 * persisted (creation use case) to allow other parts of the application to react (logging,

...
/**
 * Thrown when a domain/business invariant is violated (e.g., attempting to
 * create a user with a duplicate email when uniqueness is required). Using a
 * dedicated type allows targeted handling separate from generic validation or
...
public class BusinessRuleViolationException extends RuntimeException {
    ...
    public Object getViolatedValue() { return violatedValue; }
}

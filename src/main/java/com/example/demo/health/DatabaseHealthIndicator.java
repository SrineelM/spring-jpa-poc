...
/**
 * Proper Actuator HealthIndicator for database connectivity with timing & rich details. Exposes
 * status under /actuator/health (and groups) enabling aggregation & alerting.
 */
@Component
public class DatabaseHealthIndicator implements HealthIndicator {
  ...
  public boolean isHealthy() {
    return health().getStatus().getCode().equalsIgnoreCase("UP");
  }

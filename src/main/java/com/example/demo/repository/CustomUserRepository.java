...
/**
 * Custom repository fragment exposing ad-hoc dynamic criteria-based lookup not easily expressed as
 * a Spring Data derived query method. Implemented in {@link CustomUserRepositoryImpl} and

...
/**
 * This class is an implementation of Spring Security's {@link AuthenticationEntryPoint}. It is used
 * to handle authentication failures for unauthenticated users who are trying to access a protected
 * resource.
 *
 * <p>When an unauthenticated user attempts to access a resource that requires authentication, the
 * {@link #commence} method is triggered, and it sends an HTTP 401 Unauthorized response.
 */

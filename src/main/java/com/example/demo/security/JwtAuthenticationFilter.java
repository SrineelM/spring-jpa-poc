...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(
        ...
        if (StringUtils.hasText(token)
                && tokenProvider.validateToken(token)) { // only proceed if structurally & cryptographically valid
            ...
            UserDetails userDetails =
                    userDetailsService.loadUserByUsername(username); // load authorities to populate security context

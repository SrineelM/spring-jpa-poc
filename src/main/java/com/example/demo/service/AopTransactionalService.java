...
/**
 * This service is used to demonstrate AOP-based transaction management. Notice that this class and
 * its methods do NOT have the @Transactional annotation. The transactional behavior is applied by
 * the AOP configuration defined in {@link com.example.demo.config.AopConfig}.
 */
@Service

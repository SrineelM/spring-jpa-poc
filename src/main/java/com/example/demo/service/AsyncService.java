...
/**
 * This service demonstrates how to perform asynchronous operations in Spring.
 * The {@link Async} annotation enables methods to be executed in a separate thread,
 * allowing the caller to proceed without waiting for the task to complete.
 */
@Service
public class AsyncService {
     ...
     * <p>
     * The {@link Async} annotation tells Spring to run this method in a background thread pool.
     ...
     * <p>
     * The method returns a {@link CompletableFuture}, which is a handle to the result of the

...
/**
 * Enhanced resilience testing controller with comprehensive endpoints for testing all resilience patterns
 */
@RestController
...
public class ResilienceController {
    ...
    public CompletableFuture<ResponseEntity<Map<String, Object>>> getHealthStatus() {
        ...
        return externalApiService.isExternalServiceHealthy()
                .thenApply(healthy -> {

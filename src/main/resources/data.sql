...
VALUES
    (1, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'user1@example.com', 'user1@example.com', 'First Post', 'This is the content of the first post.', 2),
    (2, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'user2@example.com', 'user2@example.com', 'Second Post', 'This is the content of the second post.', 3),
    (3, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'user1@example.com', 'user1@example.com', 'Third Post', 'This is some more content.', 2);

-- Comments
INSERT INTO comments (id, version, created_date, last_modified_date, created_by, last_modified_by, content, post_id, user_id)
VALUES
    (1, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'user2@example.com', 'user2@example.com', 'Great post!', 1, 3),
    (2, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'user1@example.com', 'user1@example.com', 'Thanks!', 1, 2),
    (3, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'admin@example.com', 'admin@example.com', 'Interesting discussion.', 1, 1),
    (4, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'user2@example.com', 'user2@example.com', 'I agree.', 2, 3);

-- Groups
INSERT INTO groups (id, version, created_date, last_modified_date, created_by, last_modified_by, name)
VALUES
